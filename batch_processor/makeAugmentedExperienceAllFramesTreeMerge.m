function [descs_list, invkeys_list, xy_poses] = makeAugmentedExperienceAllFramesTreeMerge(testinfo, SKIP_FRAMES)

% KITTI used all frames 
...
if(strcmp(testinfo.method_, 'pc'))
    ...
    NUM_AUG_SCs = 2; % including the original (no-root-shifted)
end
descs_list = {};
invkeys_list = {};
